  ...
  return (
    ...
    top-0 z-20 backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70'>
      ...
      <img src={theme === 'dark'? assets.logo_dark : assets.logo} />
            ...
            'max-sm:w-0 overflow-hidden': 'max-sm:w-80 max-sm:pl-10'} max-sm:fixed top-0 bottom-0 right-0 max-sm:min-h-screen
            max-sm:h-full max-sm:flex-col max-sm:bg-primary max-sm:text-white max-sm:pt-20 flex sm:items-center gap-5 
            transition-all`}>
        ...
        <div className='flex items-center gap-2 sm:gap-4'>
            ...
            <div>
                ...
                bg-primary text-white px-6 py-2 rounded-full cursor-pointer hover:scale-103
                transition-all'>
